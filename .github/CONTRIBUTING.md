...
So you want to contribute to uuid-compact? We already love you! :heart:
...
- All **issues** are **welcome**.
  - These include bug reports, questions, feature requests and enhancement
    proposals
  - [GitHub's issue tracker](https://github.com/sverweij/uuid-compact/issues)
...
- Code quality
  - uuid-compact has a bunch of automated checks (test coverage, depcruise,
...
- Plan to do something drastic?  
  Leave an [issue](https://github.com/sverweij/uuid-compact/issues/new/choose)
  on GitHub, so we can talk about it.
- uuid-compact is released with a [code of conduct](../CODE_OF_CONDUCT.md), adapted
  from the [contributor covenant](http://contributor-covenant.org/).

### Legal

- the code you add will be subject to
  [the MIT license](../LICENSE), just like the rest of uuid-compact
